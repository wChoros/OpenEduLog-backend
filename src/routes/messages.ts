...
messagesRouter.get(
   '/headers/received/:userId',
   authorize('readMany', 'Message', (req) => Number(req.params.userId)),
...
//to authorize
messagesRouter.get(
   '/content/received/:messageId/',
   authorize('read', 'Message', (req) => Number(req.body.messageId)),
   async (req: Request, res: Response) => {
...
messagesRouter.get(
   '/content/sent/:messageId',
   authorize('read', 'Message',(req) => Number(req.params.messageId)) ,
   async (req: Request, res: Response) => {
      const { messageId } = req.params
...
messagesRouter.post(
   '/',
   authorize('add', 'Message', (req) => Number(req.body.user.id)),
   async (req: Request, res: Response) => {
      const user = req.body.user
